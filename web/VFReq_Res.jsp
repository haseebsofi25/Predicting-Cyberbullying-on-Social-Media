...
<div id="abstract">
    ...
    <h2 style="color:orange">View All Friends Request And Response</h2>
    <table>
        <tr><th>SENDER</th><th>SENDER NAME</th><th>RECEIVER</th><th>RECEIVER NAME</th>
        <th>DATE</th></tr>
        <%
        try{
        ...
        <tr>
            ...
            <td><%=r.getString("remail")%></td>
           <td><%=r.getString("runame")%></td>
