...
<div id="abstract">
    ...
    <div id="link2" style="width:35%;height:400px;border-left:1px solid graytext;float:right">
     ...
     <h2 style="color:orange">View Friends Post</h2>
    <table>
    ...
    <td colspan="2"><image src="view.jsp?email=<%=email1%>"</td>
           ...
           <form action="Comm_Action.jsp" method="post">
               <tr><th>Comment</th><td><input type="text" name="comment"></td><td><input type="submit" value="Comment"</td></tr>
         </form>
